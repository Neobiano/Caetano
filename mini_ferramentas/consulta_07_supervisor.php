<?php
$nome_relatorio = "tma_supervisor"; // NOME DO RELATÓRIO (UTILIZAR UNDERLINE, POIS É PARTE DO NOME DO ARQUIVO EXCEL)
$titulo = "TMA - Supervisor"; // MESMO NOME DO INDEX
...
$SOMA_TMA = 0;
	...
	echo "<br><br><b style='color: red'>Dica:</b> Clique no nome do supervisor para listar o TMA dos operadores vinculados.";
	echo '</div>';
	...
	$texto = "<td><b>NOME SUPERVISOR</b></td>";
