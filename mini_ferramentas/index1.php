	...
	<div class="w3-container">
		...
		<div class="w3-left w3-margin-top w3-margin-bottom">
			...
			<select id= "tipo_consulta" name="tipo_consulta"> <!-- 15 -->
				...
				<option value="18">Monitora Desconexões URA</option>
				<option value="19">Monitora Erros de Webservice URA</option>
				<option value="20">Monitora Desbl. Cartão via URA</option>
				<option value="09">Tradutor de Eventos URA / FRONTEND</option>
				<option value="22">Verifica Alimentação BD</option>
