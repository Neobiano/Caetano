...
<!-- TÍTULO -->
<div class='w3-container w3-padding w3-margin w3-tiny w3-center w3-indigo w3-wide w3-card-4'><b>MINI FERRAMENTAS - CONTRATO TIVIT Rio de Janeiro</b></div>
	...
	<div class="w3-container">
		...
		<div class="w3-left w3-margin-top w3-margin-bottom">
			...
			<select id= "tipo_consulta" name="tipo_consulta"> <!-- 15 -->
				...
				<option value="06" disabled>TMA e Nível de Serviço</option> <!-- Incluir Consulta por Faixa de Horário / Geral (Dia-a-Dia / Faixa Horário) / Por Ilha -->
				<option value="07" disabled>TMA - Operador / Supervisor</option>
				<option value="08" disabled>Perc. Atend. não Categorizados</option> <!-- Por Skill -->
				<option value="05" disabled>Categorização de Chamadas</option>
				<option value="12" disabled>DNS - Dispersão de Nível de Serviço</option>
				
				<option value="" class='w3-border-top w3-margin-top' style='padding-top: 16px;'disabled></option>
				<option value="15" disabled>URA - Eventos x Quantidade</option>
				<option value="18" disabled>Monitora Desconexões URA</option>
				<option value="19" disabled>Monitora Erros de Webservice URA</option>
				<option value="20" disabled>Monitora Desbl. Cartão via URA</option>
				<option value="09" disabled>Tradutor de Eventos URA / FRONTEND</option>
				<option value="22" disabled>Verifica Alimentação BD</option>
