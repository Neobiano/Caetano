<?php
$nome_relatorio = "monitora_erros_webservice_ura"; // NOME DO RELATÓRIO (UTILIZAR UNDERLINE, POIS É PARTE DO NOME DO ARQUIVO EXCEL)
$titulo = "Monitora Erros de Webservice URA"; // MESMO NOME DO INDEX
...
echo "</div>";
	...
	$query = $pdo->prepare("select a.callid, b.cod_evento, b.desc_evento from tb_eventos_ura_2 as a
						...
						and callid in (select callid from tb_eventos_ura_2 where data_hora between '$data_inicial' and '$data_final 23:59:59.999' and cod_evento = '002')
