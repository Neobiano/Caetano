...
<div class="w3-tiny w3-container w3-white w3-padding-0 w3-border-indigo-dark  w3-border  w3-card-4">	
	...
	<div class="w3-left w3-padding">
		...
		<input size='11' id="valor_atendimento" type='text' name="valor_atendimento" value='1.7009155931' onkeypress='return SomenteValor(event, this, 12)'>
		</div>
...
<div class="w3-tiny w3-container w3-section w3-white w3-padding-0 w3-border-indigo-dark w3-border w3-card-4">
	...
	<div class="div_dia"> <input class="w3-margin-8 ckb" type="checkbox" id="chk_12" name="chk_12" value = "12"  checked>12 &nbsp &nbsp</div>
	...
	<div class="div_dia"> <input class="w3-margin-8 ckb" type="checkbox" id="chk_19" name="chk_19" value = "19"  checked>19 &nbsp &nbsp</div>
	...
	<div class="div_dia"> <input class="w3-margin-8 ckb" type="checkbox" id="chk_26" name="chk_26" value = "26"  checked>26 &nbsp &nbsp</div>
...
<div class="w3-tiny w3-container w3-section w3-white w3-padding-0 w3-border-indigo-dark w3-border w3-card-4">		
		...
		<div class="div_dia w3-margin-8">14:<input size='12' id="ansm14" type='text' name="ansm14" value='0.998151' onkeypress='return SomenteValor(event, this, 12)'></div>
		...
		<div class="div_dia w3-margin-8">20:<input size='12' id="ansm20" type='text' name="ansm20" value='0.988669' onkeypress='return SomenteValor(event, this, 12)'></div>
...
<div class="w3-tiny w3-container w3-section w3-white w3-padding-0 w3-border-indigo-dark w3-border w3-card-4">		
		<div class="w3-left w3-padding">
			...
			<div class="div_dia w3-margin-8">Quantidade de Atendimentos Prestados com Falta de Cortesia e/ou Fora dos Padrões:<input size='2' id="glosa1" type='text' name="glosa1" value='39' onkeypress='return SomenteValor(event, this, 3)'></div>		
			<div class="div_dia w3-margin-8">IQF(%):<input size='12' id="iqf" type='text' name="iqf" value='90.17' onkeypress='return SomenteValor(event, this, 13)'></div>
