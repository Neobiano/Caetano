...
//define 'in' das ilhas
$ilha_retencao = "'73','77','81','85','116'"; //usa na sql ABC
$ilha_triagem = "'150'"; //usa na sql ABC
$ilha_aviso_viagem = "'125'"; //usa na sql ABC
$ilha_parcelamento = "'72','76','80','84','111'"; //usa na sql ABC
$ilha_contestacao = "'60','88','90','93','96'"; //usa na sql ABC
$ilha_pontos = "'87','91','94','97','120'"; //usa na sql ABC
$ilha_pj = "'99','101','110'";/*'100',*/ //usa na sql ABC
$ilha_caixa_empregado = "'63'"; //usa na sql ABC
$ilha_deficiente_auditivo = "'61'"; //usa na sql ABC
$ilha_mala_direta = "'64'"; //usa na sql ABC
$ilha_geral_normal = "'70','71','74','75','78','79','86','58','89','92','95','103','114','118','57'";/*'102',*/ //usa na sql ABC
$ilha_geral_premium = "'82','83','98'"; //usa na sql ABC
$ilha_bloqueio_cobranca = "'117','106','107','108','109'";  //usa na sql ABC
$ilha_app = "'102'"; //usa na sql ABC
...
for($pos_dia=01; ( $pos_dia<(01+1) ); $pos_dia++)
{
	...
	{			
		...
		if( ($valor_ca > 0) )
		{
			...
			if (in_array("$cont", $vet_retencao) or in_array("$cont", $vet_triagem) or in_array("$cont", $vet_parcelamento) or in_array("$cont", $vet_perda_roubo))  
			{
			...
			else if (in_array("$cont", $vet_contestacao) or in_array("$cont", $vet_pontos) )
			{
				
				if (in_array("$cont", $vet_contestacao))				
			...
			{
				if (($cont == 84) or ($cont == 85) or ($cont == 96) or ($cont == 97))
				{
					$qtde_acp = 0;
					$fator = 1;
				}    
			...
			if (in_array($cont, $vet_parcelamento )) 
