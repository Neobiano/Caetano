...
<?php
    ...
    */
    ...
    //define 'in' das ilhas
    $ilha_retencao = "'73','77','81','85','116'"; //ok
    $ilha_triagem = "'150','138'"; //ok
    //$ilha_aviso_viagem = "'125'"; Ilha descontinuada
    $ilha_parcelamento = "'72','76','80','84','111'"; //ok
    $ilha_contestacao = "'60','88','90','93','96'"; //ok
    $ilha_pontos = "'87','91','94','97','120','139'"; //so restou a 139, ok
    $ilha_pj = "'99','101','110'";/*'100', ,'100','130'*/ //so restou a 99 ok
    $ilha_100 = "'100'"; //ok
    $ilha_130 = "'130'"; //ok
    $ilha_caixa_empregado = "'63'"; //ok
    $ilha_deficiente_auditivo = "'61'"; //ok
    $ilha_mala_direta = "'64'"; //ok
    $ilha_geral_normal = "'70','71','74','75','78','79','86','58','89','92','95','114','118','57','137','126'";/*'102',*/
    $ilha_geral_premium = "'82','83','98'"; //OK
...
echo "<div class = 'w3-leftbar w3-border-black w3-margin-left'><div class='w3-margin-left w3-tiny'><b>( SIMULAÇÃO ) Parâmetros Utilizados:</b></div>";
echo "<br>";
...
{ 
	...
	/* aviso de viagem NÃO EXISTE MAIS
	$query = $pdo->prepare("SELECT COD_FILA,COUNT (*) TOTAL	FROM (
																	SELECT CALLID, MIN (COD_FILA) COD_FILA
																	FROM TB_EVENTOS_DAC
																	WHERE DATA_HORA BETWEEN '$qual_mes/$pos_dia/$qual_ano' AND '$qual_mes/$pos_dia/$qual_ano 23:59:59.999' 
