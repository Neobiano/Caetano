...
<!-- FORMULÁRIO - INÍCIO -->
<form action="imprime_tabela_NOVA_2.php" method="post" class="w3-container w3-tiny" target="_blank">
...
<div class="w3-tiny w3-container w3-section w3-white w3-padding-0 w3-border-indigo-dark w3-border w3-card-4">		
		<div class="w3-left w3-padding">
			...
			<div class="div_dia w3-margin-8">Quantidade de Atendimentos Prestados com Falta de Cortesia e/ou Fora dos Padrões:<input size='2' id="glosa1" type='text' name="glosa1" value='23' onkeypress='return SomenteValor(event, this, 3)'></div>		
